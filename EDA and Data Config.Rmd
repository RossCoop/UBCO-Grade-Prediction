...
df_clean <- df[,c(1,2,3,4,5,12,13,15,16,17)]
...
sorted_courses_taken_bsc <- sort(courses_taken_bsc, decreasing = TRUE)#[1:500]

sorted_courses_taken_bsc["STAT.303"]
```
