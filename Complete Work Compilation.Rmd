...
### Variable selection
This variable selection technique was taken from a **paper** with some modifications to see if removing variables improves the model. For the first few courses removed it performed alright, with a rmse of ~9. After any more than 
