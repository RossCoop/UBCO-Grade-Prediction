...
xgbm_model <- xgb.train(data=train_data, max.depth=2, eta=0.05, nthread = 2, nrounds=200, lambda = 2, booster = "gbtree", subsample = 0.5, tree_method = "auto", watchlist=watchlist, objective = "reg:squarederror", verbose = 0, early_stopping_rounds = 10)
